...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "e47e674cd09583ff0503f0f6defd6d23d8b718d3"
  WORKING_DIRECTORY "/home/embedded-415/czh-rot/HE_GPU/cmake-build/_deps/seal-build/thirdparty/zstd-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"e47e674cd09583ff0503f0f6defd6d23d8b718d3\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/embedded-415/czh-rot/HE_GPU/cmake-build/_deps/seal-build/thirdparty/zstd-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/embedded-415/czh-rot/HE_GPU/cmake-build/_deps/seal-build/thirdparty/zstd-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
